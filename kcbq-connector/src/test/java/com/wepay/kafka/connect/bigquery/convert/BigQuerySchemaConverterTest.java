...
public class BigQuerySchemaConverterTest {
    ...
    private static BigQuerySinkConfig testingConfig(boolean convertDebeziumTimestamp,
            BigQuerySinkConfig.DecimalHandlingMode varibaleScaleDecimalMode,
            BigQuerySinkConfig.DecimalHandlingMode decimalMode) {
    ...
    private BigQuerySchemaConverter createConverter() {
        ...
        return createConverter(testingConfig(false, BigQuerySinkConfig.DecimalHandlingMode.RECORD,
    ...
    public void testTopLevelSchema() {
        ...
        com.google.cloud.bigquery.Schema expectedSchema = com.google.cloud.bigquery.Schema.of(
                Field.newBuilder("key", LegacySQLTypeName.BOOLEAN)
                        .setMode(Field.Mode.REQUIRED)
                        .build());
        com.google.cloud.bigquery.Schema actualSchema = converter.convertSchema(Schema.BOOLEAN_SCHEMA);
    ...
    public void testBoolean() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.BOOLEAN).setMode(
    ...
    public void testInteger() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.INTEGER).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    public void testFloat() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.FLOAT).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    public void testStruct() { // Struct in a struct in a struct (wrapped in a struct)
        ...
        com.google.cloud.bigquery.Field bigQueryInnerRecord = com.google.cloud.bigquery.Field.newBuilder(
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedInnerSchema = com.google.cloud.bigquery.Schema
                .of(bigQueryInnerRecord);
        ...
        com.google.cloud.bigquery.Field bigQueryMiddleRecord = com.google.cloud.bigquery.Field.newBuilder(
                middleFieldStructName,
                LegacySQLTypeName.RECORD,
                bigQueryInnerRecord,
                com.google.cloud.bigquery.Field.newBuilder(
                        middleFieldArrayName,
                        LegacySQLTypeName.FLOAT).setMode(com.google.cloud.bigquery.Field.Mode.REPEATED).build())
                .setMode(
                        com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build();
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedMiddleSchema = com.google.cloud.bigquery.Schema
                .of(bigQueryMiddleRecord);
        ...
        com.google.cloud.bigquery.Field bigQueryOuterRecord = com.google.cloud.bigquery.Field.newBuilder(
                outerFieldStructName,
                LegacySQLTypeName.RECORD,
                bigQueryInnerRecord,
                bigQueryMiddleRecord).setMode(
                        com.google.cloud.bigquery.Field.Mode.REQUIRED)
                .build();
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedOuterSchema = com.google.cloud.bigquery.Schema
                .of(bigQueryOuterRecord);
    ...
    public void testMap() {
        ...
        Field floatField = Field.newBuilder(keyName, LegacySQLTypeName.FLOAT)
                .setMode(Field.Mode.REQUIRED)
                .build();
        Field stringField = Field.newBuilder(valueName, LegacySQLTypeName.STRING)
                .setMode(Field.Mode.REQUIRED)
                .build();
    ...
    public void testIntegerArray() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.INTEGER).setMode(com.google.cloud.bigquery.Field.Mode.REPEATED).build());
    ...
    public void testStringArray() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.STRING).setMode(com.google.cloud.bigquery.Field.Mode.REPEATED).build());
    ...
    public void testBytes() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.BYTES).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    public void testTimestamp() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.TIMESTAMP).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    private static Stream<Arguments> testBadTimestampData() {
        ...
        arguments.add(Arguments.of(Timestamp.LOGICAL_NAME, Timestamp.LOGICAL_NAME, testingConfig(false,
                BigQuerySinkConfig.DecimalHandlingMode.RECORD, BigQuerySinkConfig.DecimalHandlingMode.FLOAT)));
        arguments.add(Arguments.of(io.debezium.time.Timestamp.SCHEMA_NAME + " standard",
                io.debezium.time.Timestamp.SCHEMA_NAME, testingConfig(false,
                        BigQuerySinkConfig.DecimalHandlingMode.RECORD, BigQuerySinkConfig.DecimalHandlingMode.FLOAT)));
        arguments.add(Arguments.of(io.debezium.time.Timestamp.SCHEMA_NAME + " converted",
                io.debezium.time.Timestamp.SCHEMA_NAME, testingConfig(true,
                        BigQuerySinkConfig.DecimalHandlingMode.RECORD, BigQuerySinkConfig.DecimalHandlingMode.FLOAT)));
    ...
    public void testDate() {
        ...
        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        LegacySQLTypeName.DATE).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    public void testDecimal(BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode) {
        final BigQuerySinkConfig config = testingConfig(false, BigQuerySinkConfig.DecimalHandlingMode.RECORD,
                decimalHandlingMode);
        ...
        switch (decimalHandlingMode) {
            ...
            case BIGNUMERIC:
                bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                        com.google.cloud.bigquery.Field.newBuilder(
                                fieldName,
                                decimalHandlingMode.sqlTypeName).setMode(
                                        com.google.cloud.bigquery.Field.Mode.REQUIRED)
                                .setScale(0L).build());
                break;
            case FLOAT:
        ...
        com.google.cloud.bigquery.Schema bigQueryTestSchema = createConverter(config)
    ...
    private static Stream<Arguments> testBadDecimalData() {
        List<Arguments> arguments = new ArrayList<>();
        for (BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode : BigQuerySinkConfig.DecimalHandlingMode
                .values()) {
            BigQuerySinkConfig config = testingConfig(false, BigQuerySinkConfig.DecimalHandlingMode.RECORD,
                    decimalHandlingMode);
            arguments.add(Arguments.of(Decimal.LOGICAL_NAME + " " + config.getDecimalHandlingMode(),
                    Decimal.LOGICAL_NAME, config));
        }
        for (BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode : BigQuerySinkConfig.DecimalHandlingMode
                .values()) {
            BigQuerySinkConfig config = testingConfig(false, decimalHandlingMode,
                    BigQuerySinkConfig.DecimalHandlingMode.FLOAT);
            arguments.add(Arguments.of(
                    io.debezium.data.VariableScaleDecimal.LOGICAL_NAME + " "
                            + config.getVariableScaleDecimalHandlingMode(),
                    io.debezium.data.VariableScaleDecimal.LOGICAL_NAME, config));
        }
        return arguments.stream();
    }
    ...
    public void testDebeziumVariableScaleDecimal(BigQuerySinkConfig.DecimalHandlingMode decimalHandlingMode) {
        ...
        final BigQuerySinkConfig config = testingConfig(false, decimalHandlingMode,
                BigQuerySinkConfig.DecimalHandlingMode.FLOAT);
    ...
    void testDebeziumTimestamp(boolean convertFlag) {
        ...
        final BigQuerySinkConfig config = testingConfig(convertFlag, BigQuerySinkConfig.DecimalHandlingMode.RECORD,
                BigQuerySinkConfig.DecimalHandlingMode.FLOAT);

        com.google.cloud.bigquery.Schema bigQueryExpectedSchema = com.google.cloud.bigquery.Schema.of(
                com.google.cloud.bigquery.Field.newBuilder(
                        fieldName,
                        convertFlag ? LegacySQLTypeName.INTEGER : LegacySQLTypeName.TIMESTAMP).setMode(
                                com.google.cloud.bigquery.Field.Mode.REQUIRED)
                        .build());
    ...
    public void testDescription() {
        ...
        Schema kafkaConnectTestSchema = SchemaBuilder.struct()
    ...
    public void testSimpleRecursiveSchemaThrows() {
        ...
        // Construct Avro schema with recursion since we cannot directly construct
        // Connect schema with cycle
        ...
        ConversionConnectException e = assertThrows(ConversionConnectException.class,
                () -> createConverter().convertSchema(connectSchema));
